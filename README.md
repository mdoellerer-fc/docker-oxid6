...
- Apache 2.4 container PHP 8 ([Dockerfile](container/apache_php8/Dockerfile))
...
- Shop: `http://localhost` (or `https://localhost` with ssl-cert-snakeoil)
- Shop admin `http://localhost/admin/`, credentials: `admin / admin`
